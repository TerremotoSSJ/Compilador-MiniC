...
{
  "\"end of file\"", "error", "\"invalid token\"", "DIGITO", "'\\n'",
  "'+'", "'*'", "'('", "')'", "$accept", "entrada", "linea", "expr",
...
{
       2,     3,    12,     3,    14,     4,    11,     4,     9,    13,
      10,    11,     0,     0,    15
};

static const yytype_int8 yycheck[] =
{
       0,     3,     6,     3,    11,     7,     5,     7,     4,     8,
       4,     5,    -1,    -1,    12
};
